---
name: "source-command-mission-summary"
...
# source-command-mission-summary

Use this skill when the user asks to run the migrated source command `mission-summary`.
...
- Project context: `AGENTS.md` and `.Codex/projects/.../memory/MEMORY.md`
